 ...
 * l'approche de la souris). Respecte prefers-reduced-motion.
 */
export default function HeroInteractiveBackground() {
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      const density = Math.min(70, Math.max(28, Math.floor((width * height) / 22000)));
    ...
    const draw = () => {
      ...
      // Déplacement + léger effet de répulsion autour du curseur
